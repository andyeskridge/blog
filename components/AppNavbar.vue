...
<template>
  <div class="flex justify-between max-w-2xl px-4 py-4 mx-auto sm:px-8">
    ...
    <div class="space-x-3 transition text-gray-500">
      ...
      <a v-if="appConfig.socials?.linkedin" :href="`https://www.linkedin.com/in/${appConfig.socials?.linkedin}/`" title="LinkedIn" class="dark:text-gray-100 hover:text-gray-700 dark:hover:text-gray-300"><Icon name="fa-brands:linkedin" class="w-5 h-5" /></a>
